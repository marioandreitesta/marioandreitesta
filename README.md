...
> *Conhecimento que não constrói nada é conhecimento fútil.*

Estudante de programação com foco em **backend Python**. Aprendo de forma ativa — cada repositório aqui documenta o processo com honestidade, incluindo refatorações, correções e decisões técnicas registradas nos commits.

Curioso por natureza. Autodidata por escolha. Vou além do básico quando o básico já foi entendido.
...
|-------------|-----------|
| [curso-em-video-python](https://github.com/marioandreitesta/curso-em-video-python) | Exercícios, anotações e projetos do curso Python 3 — Gustavo Guanabara |
